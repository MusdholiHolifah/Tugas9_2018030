...
import static com.example.tugas9_2018030.DBmain.TABLENAME;
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_alarm) {
                    ...
                    Intent a = new Intent(MainActivity1.this, DestinationActivity.class);
                    startActivity(a);
        ...
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rec != null) {
                    ...
                    Toast.makeText(MainActivity1.this, "Something Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //for view display
        ...
        binding.btnEdit.setOnClickListener(new
                                                   View.OnClickListener() {
                                                       ...
                                                       public void onClick(View v) {
                                                           ...
                                                           if(recedit != -1){
                                                               Toast.makeText(MainActivity1.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
                                                               ...
                                                               binding.btnSubmit.setVisibility(View.VISIBLE);Intent a = new Intent(MainActivity1.this, DisplayData.class);
                                                               startActivity(a);
                                                           }
                                                       }
                                                   });
